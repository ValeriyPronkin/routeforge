...
class Settings:
    ...
    #: Порог остатка смены, ниже которого машина реестра на линию больше не
    #: выводится: за оставшиеся минуты она не успеет даже доехать. В исходном
    #: приложении это были 40 минут, зашитые в код.
    vehicle_min_remaining_min: int = 40
    #: Запас вместимости при наборе машин на кластер, в единицах спроса.
    #: Ноль — набирать впритык под спрос.
