...
**Машина** — один маршрут: выезд с базы, объезд точек, возврат. Число машин
выводится из вместимости и длительности смены, а не задаётся вручную.
...
Образцы обоих файлов — `data/sample/sites.csv` и `data/sample/depots.csv`.
...
flowchart TD
    ...
    FL["5 · Сколько нужно машин<br/>максимум из двух оценок:<br/>по вместимости и по смене"]
    SV["6 · CVRP солвером OR-Tools<br/>маршрут: база → точки → база"]
    AD["7 · Добор машин<br/>auto_add_vehicles"]
