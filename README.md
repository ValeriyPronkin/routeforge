...
площадок при сборе ТКО. Отправной точкой в 2023 году послужил
[bruscalia/tsp-app](https://github.com/bruscalia/tsp-app) — небольшое
приложение на Streamlit для задачи коммивояжёра под лицензией MIT; оттуда
была взята идея интерфейса.

В этой публичной версии кода оттуда не осталось: солвер, кластеризация,
работа с расстояниями, пайплайн и интерфейс написаны заново. Упоминание
здесь — дань происхождению, а не лицензионное требование.
